  ...
  return (() => {
    var t = {
            ...
            function t(e) {
              ...
              (this._options = n({}, s, e)),
                ...
                this._options.names.forEach(function (t) {
                  i._instances[t] = new r(
                    i._options.initialValue,
                    i._options.acceleration,
                    i._options.friction
                  );
                }),
                (this._raf = null);
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    Object.keys(this._instances).forEach(function (n) {
                      t._instances[n].update(),
                        t._options.test(t._instances[n]) && (e = !1);
                    }),
                      e
                        ? (Object.keys(this._instances).forEach(function (e) {
                            (t._instances[e].current = t._instances[e].target),
                              (t._instances[e].velocity = 0);
                          }),
        ...
        279: (t, e, n) => {
          ...
          t.exports = function (t, e, n) {
            ...
            return (
              ...
              i(n) &&
                ((v = !!n.leading),
                (u = (m = "maxWait" in n) ? r(s(n.maxWait) || 0, e) : u),
            ...
            l = (function () {
                ...
                (this.options = {
                  ...
                  (this.updateOptions = function (t) {
                    if (
                      ...
                      e.options.invert &&
                        (e.color = a.convertColor("rgb(255, 255, 255)")),
                      e.options.dotColor)
                    ) {
                      if (
                        (e.globalStyles &&
                          (document.head.removeChild(e.globalStyles),
                          (e.globalStyles = void 0)),
                        !e.globalStyles)
                      ) {
                        var n =
                          ...
                          '" height="' +
                          e.options.dotSize +
                          '"\n                viewBox="0 0 8 8"><circle cx="4" cy="4" r="4" fill-rule="evenodd" fill="' +
                          e.options.dotColor +
                          '"/></svg>';
                        (e.globalStyles = document.createElement("style")),
                          e.globalStyles.setAttribute(
                            "data-blobity-global-styles",
                            ""
                          ),
                          e.globalStyles.appendChild(
                      ...
                      e.kinetInstance &&
                        (Object.entries(e.kinetInstance._instances)
                          ...
                          .forEach(function (t) {
                            var n = t[1];
                            (n._friction =
                              1 - e.kinetPresets[e.options.mode].friction),
                              (n._acceleration =
                                e.kinetPresets[e.options.mode].acceleration);
                          }),
                        e.stickedToElement ||
                          e.sticketToElementTooltip ||
                          (void 0 !== t.radius &&
                            e.kinetInstance[e.kinetDefaultMethod](
                              "radius",
                              e.options.radius
                            ),
                          e.kinetInstance[e.kinetDefaultMethod](
                          ...
                          e.kinetInstance[e.kinetDefaultMethod](
                            "x",
                            e.lastKnownCoordinates.x - e.options.size / 2
                          ),
                          e.kinetInstance[e.kinetDefaultMethod](
                            "y",
                            e.lastKnownCoordinates.y - e.options.size / 2
                          )));
                  }),
                  (this.destroy = function () {
                    e.destroyed ||
                      ...
                      document.removeEventListener(
                        "mouseover",
                        e.focusableElementMouseEnter
                      ),
                      document.removeEventListener(
                        "mouseout",
                        e.focusableElementMouseLeave
                      ),
                      ...
                      e.prefersReducedMotionMediaQuery.removeEventListener(
                        "change",
                        e.updatePrefersReducedMotionSetting
                      ),
                  ...
                  (this.disable = function () {
                    (e.disableTimeStamp = new Date().getTime()),
                      (e.isActive = !1),
                      e.clear();
                  }),
                  (this.enable = function () {
                    new Date().getTime() - e.disableTimeStamp > 16 &&
                      (e.isActive = !0);
                  }),
                  (this.updatePrefersReducedMotionSetting = function () {
                    (e.reduceMotionSetting =
                      e.prefersReducedMotionMediaQuery.matches),
                      (e.kinetDefaultMethod = e.reduceMotionSetting
                        ? "set"
                        : "animate");
                  }),
                  (this.focusElement = function (t) {
                    (e.manuallySetTooltipText = null),
                      (e.manuallySetFocusedElement = t),
                      e.highlightElement(t);
                  }),
                  (this.showTooltip = function (t) {
                    (e.manuallySetFocusedElement = null),
                      (e.manuallySetTooltipText = t),
                      e.displayTooltip(
                        t,
                        e.lastKnownCoordinates.x,
                        e.lastKnownCoordinates.y
                      );
                  }),
                  (this.reset = function () {
                    (e.manuallySetFocusedElement = null),
                    ...
                    if (e.isActive && t.target) {
                      ...
                      if (n) {
                        ...
                        n && null != i && (e.sticketToElementTooltip = i),
                          (e.currentOffsetX = n.getAttribute(
                            "data-blobity-offset-x"
                          )
                            ? parseInt(
                                String(n.getAttribute("data-blobity-offset-x"))
                              )
                            : e.options.focusableElementsOffsetX),
                          (e.currentOffsetY = n.getAttribute(
                            "data-blobity-offset-y"
                          )
                            ? parseInt(
                                String(n.getAttribute("data-blobity-offset-y"))
                              )
                            : e.options.focusableElementsOffsetY);
                        var o = n.getAttribute("data-blobity-magnetic");
                        e.reduceMotionSetting ||
                          (("true" === o ||
                            (e.options.magnetic && "false" !== o)) &&
                            ((e.currentMagnetic = new c.default(n)),
                            (e.currentMagnetic.onTick = function () {
                              if (
                                !e.activeTooltip &&
                                e.activeFocusedElement === n
                              ) {
                                ...
                                e.kinetInstance[e.kinetDefaultMethod](
                                  ...
                                  e.morph(
                                    {
                                      width: i + 2 * e.currentOffsetX,
                                      height: o + 2 * e.currentOffsetY,
                                      x: s - e.currentOffsetX,
                                      y: r - e.currentOffsetY,
                                    },
                  ...
                  (this.focusableElementMouseLeave = function (t) {
                    t.target &&
                      ...
                      (e.currentOffsetY = e.options.focusableElementsOffsetY),
                      e.currentMagnetic &&
                        (e.currentMagnetic.destroy(),
                        (e.currentMagnetic.onTick = null),
                        (e.currentMagnetic = null)),
                  ...
                  (this.displayTooltip = function (t, n, i) {
                    ...
                    e.kinetInstance[e.kinetDefaultMethod]("textOpacity", 100),
                      e.morph(
                        { x: n + 6, y: i + 6, width: r + a, height: s + a },
                        4
                      );
                  }),
                  (this.mouseMove = function (t) {
                    e.initialized
                      ? ((e.lastKnownCoordinates = {
                          x: t.clientX,
                          y: t.clientY,
                        }),
                        e.activeTooltip
                          ...
                          : (e.kinetInstance[e.kinetDefaultMethod](
                            ...
                            e.kinetInstance[e.kinetDefaultMethod](
                              "x",
                              t.clientX - e.options.size / 2
                            ),
                            e.kinetInstance[e.kinetDefaultMethod](
                              "y",
                              t.clientY - e.options.size / 2
                            ),
                            e.kinetInstance[e.kinetDefaultMethod](
                              "width",
                              e.options.size
                  ...
                  (this.resetMorph = function (t, n) {
                    e.disablingStickedToElementTimeout = setTimeout(
                      function () {
                        e.kinetInstance[e.kinetDefaultMethod](
                          "width",
                          e.options.size
                  ...
                  document.addEventListener(
                    "mouseenter",
                    this.windowMouseEnter
                  ),
                  document.addEventListener(
                    "mouseleave",
                    this.windowMouseLeave
                  ),
                  document.addEventListener(
                    "mouseover",
              ...
              return (
                ...
                Object.defineProperty(t.prototype, "activeFocusedElement", {
                  get: function () {
                    return (
                      this.manuallySetFocusedElement || this.stickedToElement
                    );
                  },
                  enumerable: !1,
                  configurable: !0,
                ...
                (t.prototype.morph = function (t, e) {
                  var n = t.width,
                    ...
                    o = t.x,
                    s = t.y;
                  this.disablingStickedToElementTimeout &&
                ...
                (t.prototype.render = function (t, e, n, i, o, s, r, c, l, u) {
                  this.clear();
                  var d = this.activeFocusedElement
                    ? 0
                  ...
                  if (
                    ...
                    (n =
                      (this.activeTooltip ? n : Math.max(n, d)) *
                      window.devicePixelRatio),
                    (i =
                      (this.activeTooltip ? i : Math.max(i, d)) *
                      window.devicePixelRatio),
                    ...
                    var f =
                      Math.abs(
                        n - this.options.size * window.devicePixelRatio
                      ) < 2 &&
                      Math.abs(
                        i - this.options.size * window.devicePixelRatio
                      ) < 2 &&
                      Math.abs(
                        o - (this.options.size * window.devicePixelRatio) / 2
                      ) < 2;
                    if (f) {
                      var p = (180 * Math.atan2(r, s)) / Math.PI + 180;
                      h.translate(o, o),
                        h.rotate((p * Math.PI) / 180),
                        h.translate(-o, -o);
                    }
                    var v = f
                      ? Math.min(
            ...
            r = (function () {
                ...
                (this.destroying = !1),
                  ...
                  (this.destroy = function () {
                    window.removeEventListener(
                      ...
                      (e.destroying = !0),
                      e.kinetInstance.animate("x", 0),
                      e.kinetInstance.animate("y", 0);
                  }),
                  (this.mouseMove = function (t) {
                    var n = e.getDistance(
                      t.clientX + window.scrollX,
                      t.clientY + window.scrollY
                    );
                    e.render(
                      n,
                      -1 * (e.center.x - t.clientX - window.scrollX),
                      -1 * (e.center.y - t.clientY - window.scrollY)
                    );
                  }),
                  (this.kinetInstance = new o.default({
                    names: ["x", "y"],
                    acceleration: 0.1,
                    friction: 0.4,
                  })),
              ...
              return (
                (t.prototype.getDistance = function (t, e) {
                  return Math.round(
                    Math.sqrt(
                      Math.pow(this.center.x - t, 2) +
                        Math.pow(this.center.y - e, 2)
                    )
                  );
                }),
                (t.prototype.render = function (t, e, n) {
                  if (
                    Math.abs(e) < this.maxDistanceX &&
                    Math.abs(n) < this.maxDistanceY
                  ) {
                    var i = e / this.maxDistanceX,
                      o = n / this.maxDistanceY;
                    this.kinetInstance.animate("x", Math.round(20 * i)),
                      this.kinetInstance.animate("y", Math.round(20 * o));
                  } else
        ...
        419: function (t, e, n) {
          ...
          if (s) {
            var r = new URL(s.src).searchParams;
            null !== r.get("autoStart") &&
              (window.blobity = new o.default({
                licenseKey: r.get("licenseKey"),
              }));
          }
        },
        382: (t, e) => {
